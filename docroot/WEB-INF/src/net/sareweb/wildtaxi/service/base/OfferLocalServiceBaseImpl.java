 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.wildtaxi.service.impl.OfferLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link net.sareweb.wildtaxi.service.OfferLocalServiceUtil} to access the offer local service.
 * </p>
 *
 * @author Sareweb
...
public abstract class OfferLocalServiceBaseImpl implements OfferLocalService {
	...
	public Offer addOffer(Offer offer) throws SystemException {
		...
		return offerPersistence.update(offer, false);
	}
	...
	public void deleteOffer(long offerId)
		...
		offerPersistence.remove(offerId);
	}
	...
	public Offer updateOffer(Offer offer) throws SystemException {
		...
		return offerPersistence.update(offer, true);
	}
	...
	public Offer updateOffer(Offer offer, boolean merge)
		...
		return offerPersistence.update(offer, merge);
	}
