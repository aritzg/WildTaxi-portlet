 ...
 * @generated
 */
public class OfferJSONSerializer {
	public static JSONObject toJSONObject(Offer model) {
		...
		jsonObj.put("agreementKey", model.getAgreementKey());
	...
	public static JSONArray toJSONArray(
		net.sareweb.wildtaxi.model.Offer[] models) {
	...
	public static JSONArray toJSONArray(
		List<net.sareweb.wildtaxi.model.Offer> models) {
		JSONArray jsonArray = JSONFactoryUtil.createJSONArray();
