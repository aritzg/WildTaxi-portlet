...
public class MessageLocalServiceClp implements MessageLocalService {
	...
	public net.sareweb.wildtaxi.model.Message addMessage(
		...
		return (net.sareweb.wildtaxi.model.Message)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<net.sareweb.wildtaxi.model.Message> getMessages(
		...
		return (java.util.List<net.sareweb.wildtaxi.model.Message>)ClpSerializer.translateOutput(returnObj);
	}
	...
	private MethodKey _addMessageMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
			"addMessage", net.sareweb.wildtaxi.model.Message.class);
	...
	private MethodKey _deleteMessageMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
			"deleteMessage", net.sareweb.wildtaxi.model.Message.class);
	...
	private MethodKey _updateMessageMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
			"updateMessage", net.sareweb.wildtaxi.model.Message.class);
